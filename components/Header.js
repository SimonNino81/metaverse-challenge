        ...
        text-pink-500 border-b-2 border-pink-700">
         ...
         lg:items-center">
            <div className="relative h-24 w-24 mx-auto hidden lg:inline-grid">
                ...
                src="https://papik.pro/uploads/posts/2021-09/1630704307_24-papik-pro-p-kiberpank-art-risunok-27.jpg"/>
            </div>
                <div className='col-span-4 text-left lg:text-center'>
                    ...
                    <h1 className="text-3xl">Welcome to the Frihet Metaverse</h1>
